 ...
 */
@Component
public class BuildViewPacker extends BaseJenkinsDecorator {
    ...
    public void wrap(CiJobBuildVO.IBuildView iBuildView) {
    ...
    public void wrap(CdJobBuildVO.IBuildView iBuildView) {
