...
public class CiJobBuildBuilder {
    ...
    public static CsCiJobBuild build(CsApplication csApplication, CsCiJob csCiJob, JobEngineVO.JobEngine jobEngine, JobParametersContext jobParamDetail, GitlabBranch gitlabBranch,
    ...
    private static CsCiJobBuild covert(CiJobBuildBO bo) {
        return BeanCopierUtil.copyProperties(bo, CsCiJobBuild.class);
    }
}
